...
;(function (global, factory) {
  ...
  function ($, window, document, Math, undefined) {
      ...
      options = $.extend(
        {
          ...
          scrollBar: false,
          hybrid: false,
          scrollSectionToBottomFromBottom: true,
      ...
      */
      ...
      function getDestinationPosition(element) {
        ...
        if (element.outerHeight() > windowsHeight) {
          //scrolling up?
          if (!isScrollingDown && options.scrollSectionToBottomFromBottom) {
            position = sectionBottom
          } else if (
            isScrollingDown &&
            element[0].classList.contains('fp-scroll-down')
          ) {
            position = sectionBottom
          } else if (
            !isScrollingDown &&
        ...
        if (
          !isScrollingDown &&
          element[0].classList.contains('fp-header-height-bt')
        ) {
          position =
            elemPosition.top - document.querySelector('header').offsetHeight
        }
        if (
          isScrollingDown &&
          element[0].classList.contains('fp-header-height-tp')
        ) {
          console.log('log')
          position =
            sectionBottom - document.querySelector('header').offsetHeight
        }
        ...
        //sections equal or smaller than the viewport height && scrolling down? ||  is resizing and its in the last section
          ...
          (isResizing &&
            ...
            options.scrollSectionToBottomFromBottom)
        ) {
    ...
    var iscrollHandler = {
       ...
       */
      onLeave: function () {
        var scroller = $(SECTION_ACTIVE_SEL)
          .find(SCROLLABLE_SEL)
